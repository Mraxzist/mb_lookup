...
- 🧪 **Malware-research**: подбор образцов по сигнатуре/семейству для личных исследований.
- 🔍 **Hunting / Threat Intel**: поиск по `first_seen_utc` и родственным семействам/сигнатурам.
